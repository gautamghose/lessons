        ...
        for d in graph[last_v]:
            for p_list in partial_lists:
                ...
                for v in p_list:
                    ...
                    idx += 1
                if idx < len(p_list):
                    #append p_lst[idx:] to lst, and then append to newly_partial_lists
                    new_partial_lst = list(lst)
                    new_partial_lst += p_list[idx:]
                    newly_partial_lists.append(new_partial_lst)

    for lst in newly_partial_lists:
        partial_lists.append(lst)
...
def main():
    ...
    #invoke the main graph traversal
    build_list_starter()

    #rebuild the partial lists
